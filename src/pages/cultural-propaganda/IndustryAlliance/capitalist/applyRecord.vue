          ...
          <div class="firstItem" v-for="(item, index) in state.tableList1" :key="index">
            ...
            <div class="itemTop" @click="toDetail(item)">
              ...
              <div class="itemSec">
                ...
                <div class="statusCon static1">{{ item.name }}</div>
              </div>
              <div class="itemThird">
                <div class="titleItem">统一社会信用代码：</div>
                <div class="statusCon static1">{{ item.social_code }}</div>
              </div>
            ...
            <div class="itemBottom" v-if="item.status == 0 || item.status == 1 || item.status == 3">
