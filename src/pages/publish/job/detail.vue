  ...
  <div class="jobDetailCon">
    <div class="topCon">
      <div class="banner">
        <van-swipe class="my-swipe" indicator-color="white" :loop="false">
          <van-swipe-item v-for="(item, index) in state.info.image_path" :key="index">
            <div class="imgbox">
      ...
      <div class="topInfoCon">
        ...
        <div class="priceCon">
          ...
          <div class="tagCon">
            <div class="priceTag leftTag" :class="[state.ZLBFitForOld ? 'priceTagOld' : '']">
              {{ state.info.category_data }}
            </div>
            <div class="priceTag" :class="[state.ZLBFitForOld ? 'priceTagOld' : '']" v-if="state.info.crop_category_name">
    ...
    <div class="middleCon">
      <div class="middleTimeCon">
        <div class="timeTitle" :class="[state.ZLBFitForOld ? 'timeTitleOld' : '']">详细信息</div>
      </div>
      <!-- <div class="fakeBorder"></div> -->
      <div class="content" :class="[state.ZLBFitForOld ? 'timeTitleOld' : '']">
        {{ state.info.issue_content }}
      </div>
      <div class="timeTitle" :class="[state.ZLBFitForOld ? 'timeTitleOld' : '']">公司地址</div>
      <!-- <div
        v-if="state.ZLBFLAG"
        class="address"
      ...
      >
        {{
          state.info.address.replace(state.info.address.substr(2, 4), '****')
        }}
      </div> -->
      ...
      <div v-else class="address">{{ state.info.address }}</div>
    ...
    <div class="bottomCon">
      <div class="fakeBtn ableBtn" :class="[state.ZLBFitForOld ? 'fakeBtnOld' : '']" v-if="state.ZLBFLAG" @click="callPhone">电话联系</div>
