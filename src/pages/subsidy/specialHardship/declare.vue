<template>
  <div class="outer">
    <div class="steps">
      <!-- <div>
        <img :src="state.img1" alt="" v-show="active === '1'" />
        <img :src="state.img2" alt="" v-show="active === '2'" />
        <p :style="{ color: '#FF814F' }">基本信息填写</p>
      </div>
       <span></span>
      <div>
        <img :src="state.img3" alt="" v-show="active === '1'" />
        <img :src="state.img4" alt="" v-show="active === '2'" />
        <p :style="{ color: active === '2' ? '#FF814F' : '#666' }">
          证明材料上传
        </p>
            </div>-->
    </div>
...
export default {
  ...
  setup() {
    ...
    const state = reactive({
      img1: require('@/assets/imgs/step1.png'),
      img2: require('@/assets/imgs/step_ok.png'),
      img3: require('@/assets/imgs/step2.png'),
      img4: require('@/assets/imgs/step2_s.png'),
      ZLBFLAG: isZLB()
    })
    const info = reactive({
      name: '',
    ...
    // const onSchool = (e) => {
    //   info.schoolType = e;
    //   schoolState.show = false;
    // }
    // const selectSchool = () => {
    //   schoolState.show = true;
    // }
